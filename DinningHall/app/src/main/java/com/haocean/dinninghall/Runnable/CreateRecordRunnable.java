...
public class CreateRecordRunnable implements Runnable  {
    ...
    public void getDataList(){
        ...
        if(id==null){
           url="http://192.168.199.142/4.1banben/"+TypeRecord+"Android/save";
        }
        else{
            System.out.println("-------HAHAHA---------");
            url="http://192.168.199.142/4.1banben/"+TypeRecord+"Android/save?id="+id;
        }
