...
public class RatingRightFragment extends Fragment implements View.OnClickListener{
	View _RootView;
	SafetyListActivity activity;
	private Map<String,String> searchMap=new HashMap<String, String>();
	String[] assessment_levelstr={"优秀","良好","一般","整改"};
	Button firstime,lastime,assessment_level;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		_RootView = inflater.inflate(R.layout.rating_criteria_menu0, null);
		...
		assessment_level= (Button)	_RootView.findViewById(R.id.assessment_level);
	...
	public void onClick(View view) {
		...
		switch (id) {
			...
			case R.id.assessment_level: {
				MyDialogs.cereateDialog(assessment_level,assessment_levelstr,activity);
			}
			break;
		}
	}
