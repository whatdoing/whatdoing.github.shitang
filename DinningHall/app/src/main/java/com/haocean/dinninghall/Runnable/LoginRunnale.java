    ...
    public boolean login(String strUrl, String username, String password) {
        ...
        try {
            ...
            if (responseEntity != null) {
                ...
                System.out.println(httpurl+"UserAndroid/listInfo?id="+jsonObject.getString("id"));

                    //一定要在这里加,,同一个cookie队列
                   httpPost = new HttpPost(httpurl+"UserAndroid/listInfo?id="+jsonObject.getString("id"));
