...
public class AdditiveRightFragment extends Fragment implements View.OnClickListener{
	View _RootView;
	RecordListActivity activity;
	private Map<String,String> searchMap=new HashMap<String, String>();
	Button end_date,first_date,name;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		_RootView = inflater.inflate(R.layout.right_fragment_menu3, null);
		...
		name= (Button) _RootView.findViewById(R.id.name);
